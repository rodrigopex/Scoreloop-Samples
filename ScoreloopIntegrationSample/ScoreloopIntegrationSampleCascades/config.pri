...
device {
    CONFIG(debug, debug|release) {
        ...
        SOURCES +=  $$quote($$BASEDIR/src/ScoreloopBpsEventHandler.cpp) \
                 $$quote($$BASEDIR/src/ScoreloopData.cpp) \
                 $$quote($$BASEDIR/src/ScoreloopSampleCascades.cpp) \
                 $$quote($$BASEDIR/src/main.cpp)

        HEADERS +=  $$quote($$BASEDIR/src/ScoreloopBpsEventHandler.hpp) \
                 $$quote($$BASEDIR/src/ScoreloopData.hpp) \
                 $$quote($$BASEDIR/src/ScoreloopDefines.hpp) \
                 $$quote($$BASEDIR/src/ScoreloopSampleCascades.hpp)
    }
